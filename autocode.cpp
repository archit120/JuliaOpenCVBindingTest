...
JLCXX_MODULE cv(jlcxx::Module &mod)
{
    ...
    mod.method("jlopencv_cv_Algorithm_getDefaultName", [](Algorithm &cobj) { auto retval = cobj.getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_KeyPoint_overlap", [](KeyPoint &cobj, KeyPoint &kp1, KeyPoint &kp2) { auto retval = cv::KeyPoint::overlap(kp1, kp2); return retval; });
    mod.add_type<cv::DMatch>("DMatch")
        ...
        .method("jlopencv_DMatch_get_distance", [](const cv::DMatch &cobj) { return cobj.distance; });
    ...
    mod.method("jlopencv_cv_GeneralizedHough_detect", [](cv::Ptr<GeneralizedHough> &cobj, Mat &image, Mat positions, Mat& votes) { cobj->detect(image, positions, votes);  return make_tuple<Mat,Mat>(positions,votes); });
    mod.method("jlopencv_cv_GeneralizedHough_detect", [](cv::Ptr<GeneralizedHough> &cobj, UMat &image, UMat &positions, UMat &votes) { cobj->detect(image, positions, votes);  return make_tuple<UMat,UMat>(positions,votes); });
    mod.method("jlopencv_cv_GeneralizedHough_detect", [](cv::Ptr<GeneralizedHough> &cobj, Mat &edges, Mat &dx, Mat &dy, Mat &positions, Mat &votes) { cobj->detect(edges, dx, dy, positions, votes);  return make_tuple<Mat,Mat>(positions,votes); });
    mod.method("jlopencv_cv_GeneralizedHough_detect", [](cv::Ptr<GeneralizedHough> &cobj, UMat &edges, UMat &dx, UMat &dy, UMat &positions, UMat &votes) { cobj->detect(edges, dx, dy, positions, votes);  return make_tuple<UMat,UMat>(positions,votes); });
    ...
    mod.method("jlopencv_cv_GeneralizedHough_getMaxBufferSize", [](cv::Ptr<GeneralizedHough> &cobj) { auto retval = cobj->getMaxBufferSize();  return retval; });
    ...
    mod.method("jlopencv_cv_GeneralizedHoughBallard_getVotesThreshold", [](cv::Ptr<GeneralizedHoughBallard> &cobj) { auto retval = cobj->getVotesThreshold();  return retval; });
    ...
    mod.method("jlopencv_cv_GeneralizedHoughGuil_getPosThresh", [](cv::Ptr<GeneralizedHoughGuil> &cobj) { auto retval = cobj->getPosThresh();  return retval; });
    ...
    mod.method("jlopencv_cv_CLAHE_collectGarbage", [](cv::Ptr<CLAHE> &cobj) { cobj->collectGarbage();  ; });
    ...
    mod.method("jlopencv_cv_Subdiv2D_locate", [](Subdiv2D &cobj, Point2f &pt) {int edge;int vertex; auto retval = cobj.locate(pt, edge, vertex);  return make_tuple<int,int,int>(retval,edge,vertex); });
    mod.method("jlopencv_cv_Subdiv2D_findNearest", [](Subdiv2D &cobj, Point2f &pt) {Point2f nearestPt; auto retval = cobj.findNearest(pt, &nearestPt);  return make_tuple<int,Point2f>(retval,nearestPt); });
    ...
    mod.method("jlopencv_cv_Subdiv2D_getVoronoiFacetList", [](Subdiv2D &cobj, vector<int> &idx) {vector<vector<Point2f>> facetList;vector<Point2f> facetCenters; cobj.getVoronoiFacetList(idx, facetList, facetCenters);  return make_tuple<vector<vector<Point2f>>,vector<Point2f>>(facetList,facetCenters); });
    mod.method("jlopencv_cv_Subdiv2D_getVertex", [](Subdiv2D &cobj, int &vertex) {int firstEdge; auto retval = cobj.getVertex(vertex, &firstEdge);  return make_tuple<Point2f,int>(retval,firstEdge); });
    ...
    mod.method("jlopencv_cv_Subdiv2D_edgeOrg", [](Subdiv2D &cobj, int &edge) {Point2f orgpt; auto retval = cobj.edgeOrg(edge, &orgpt);  return make_tuple<int,Point2f>(retval,orgpt); });
    mod.method("jlopencv_cv_Subdiv2D_edgeDst", [](Subdiv2D &cobj, int &edge) {Point2f dstpt; auto retval = cobj.edgeDst(edge, &dstpt);  return make_tuple<int,Point2f>(retval,dstpt); });
    mod.add_type<cv::LineSegmentDetector>("LineSegmentDetector", jlcxx::julia_base_type<cv::Algorithm>())

        ;
    mod.method("jlopencv_cv_LineSegmentDetector_detect", [](cv::Ptr<LineSegmentDetector> &cobj, Mat &_image, Mat &_lines, Mat &width, Mat &prec, Mat &nfa) { cobj->detect(_image, _lines, width, prec, nfa);  return make_tuple<Mat,Mat,Mat,Mat>(_lines,width,prec,nfa); });
    mod.method("jlopencv_cv_LineSegmentDetector_detect", [](cv::Ptr<LineSegmentDetector> &cobj, UMat &_image, UMat &_lines, UMat &width, UMat &prec, UMat &nfa) { cobj->detect(_image, _lines, width, prec, nfa);  return make_tuple<UMat,UMat,UMat,UMat>(_lines,width,prec,nfa); });
    ...
    mod.method("jlopencv_cv_LineSegmentDetector_compareSegments", [](cv::Ptr<LineSegmentDetector> &cobj, Size &size, Mat &lines1, Mat &lines2, Mat &_image) { auto retval = cobj->compareSegments(size, lines1, lines2, _image);  return make_tuple<int,Mat>(retval,_image); });
    mod.method("jlopencv_cv_LineSegmentDetector_compareSegments", [](cv::Ptr<LineSegmentDetector> &cobj, Size &size, UMat &lines1, UMat &lines2, UMat &_image) { auto retval = cobj->compareSegments(size, lines1, lines2, _image);  return make_tuple<int,UMat>(retval,_image); });
    mod.add_type<cv::CirclesGridFinderParameters>("CirclesGridFinderParameters")
        ...
        .method("jlopencv_CirclesGridFinderParameters_get_maxRectifiedDistance", [](const cv::CirclesGridFinderParameters &cobj) { return cobj.maxRectifiedDistance; });
    ...
    mod.method("jlopencv_cv_StereoMatcher_setDisp12MaxDiff", [](cv::Ptr<StereoMatcher> &cobj, int &disp12MaxDiff) { cobj->setDisp12MaxDiff(disp12MaxDiff);  ; });
    ...
    mod.method("jlopencv_cv_StereoBM_create", [](cv::Ptr<StereoBM> &cobj, int &numDisparities, int &blockSize) { auto retval = cv::StereoBM::create(numDisparities, blockSize); return retval; });
    ...
    mod.method("jlopencv_cv_Feature2D_compute", [](cv::Ptr<Feature2D> &cobj, Mat &image, vector<KeyPoint> &keypoints, Mat &descriptors) { cobj->compute(image, keypoints, descriptors);  return make_tuple<vector<KeyPoint>,Mat>(keypoints,descriptors); });
    mod.method("jlopencv_cv_Feature2D_compute", [](cv::Ptr<Feature2D> &cobj, UMat &image, vector<KeyPoint> &keypoints, UMat &descriptors) { cobj->compute(image, keypoints, descriptors);  return make_tuple<vector<KeyPoint>,UMat>(keypoints,descriptors); });
    mod.method("jlopencv_cv_Feature2D_compute", [](cv::Ptr<Feature2D> &cobj, vector<Mat> &images, vector<vector<KeyPoint>> &keypoints) {vector<Mat> descriptors; cobj->compute(images, keypoints, descriptors);  return make_tuple<vector<vector<KeyPoint>>,vector<Mat>>(keypoints,descriptors); });
    mod.method("jlopencv_cv_Feature2D_compute", [](cv::Ptr<Feature2D> &cobj, vector<UMat> &images, vector<vector<KeyPoint>> &keypoints) {vector<UMat> descriptors; cobj->compute(images, keypoints, descriptors);  return make_tuple<vector<vector<KeyPoint>>,vector<UMat>>(keypoints,descriptors); });
    mod.method("jlopencv_cv_Feature2D_detectAndCompute", [](cv::Ptr<Feature2D> &cobj, Mat &image, Mat &mask, Mat &descriptors, bool &useProvidedKeypoints) {vector<KeyPoint> keypoints; cobj->detectAndCompute(image, mask, keypoints, descriptors, useProvidedKeypoints);  return make_tuple<vector<KeyPoint>,Mat>(keypoints,descriptors); });
    mod.method("jlopencv_cv_Feature2D_detectAndCompute", [](cv::Ptr<Feature2D> &cobj, UMat &image, UMat &mask, UMat &descriptors, bool &useProvidedKeypoints) {vector<KeyPoint> keypoints; cobj->detectAndCompute(image, mask, keypoints, descriptors, useProvidedKeypoints);  return make_tuple<vector<KeyPoint>,UMat>(keypoints,descriptors); });
    ...
    mod.method("jlopencv_cv_Feature2D_getDefaultName", [](cv::Ptr<Feature2D> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_BRISK_getOctaves", [](cv::Ptr<BRISK> &cobj) { auto retval = cobj->getOctaves();  return retval; });
    ...
    mod.method("jlopencv_cv_ORB_getDefaultName", [](cv::Ptr<ORB> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_MSER_detectRegions", [](cv::Ptr<MSER> &cobj, Mat &image) {vector<vector<Point>> msers;vector<Rect> bboxes; cobj->detectRegions(image, msers, bboxes);  return make_tuple<vector<vector<Point>>,vector<Rect>>(msers,bboxes); });
    mod.method("jlopencv_cv_MSER_detectRegions", [](cv::Ptr<MSER> &cobj, UMat &image) {vector<vector<Point>> msers;vector<Rect> bboxes; cobj->detectRegions(image, msers, bboxes);  return make_tuple<vector<vector<Point>>,vector<Rect>>(msers,bboxes); });
    ...
    mod.method("jlopencv_cv_MSER_getDefaultName", [](cv::Ptr<MSER> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_FastFeatureDetector_getDefaultName", [](cv::Ptr<FastFeatureDetector> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_AgastFeatureDetector_getDefaultName", [](cv::Ptr<AgastFeatureDetector> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_GFTTDetector_getDefaultName", [](cv::Ptr<GFTTDetector> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_SimpleBlobDetector_getDefaultName", [](cv::Ptr<SimpleBlobDetector> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    mod.add_type<cv::SimpleBlobDetector::Params>("SimpleBlobDetector_Params")
        ...
        .method("jlopencv_SimpleBlobDetector_Params_get_maxConvexity", [](const cv::SimpleBlobDetector::Params &cobj) { return cobj.maxConvexity; });
    mod.add_type<SimpleBlobDetector::Params>("SimpleBlobDetector_Params")
        .constructor<>()
    ...
    mod.method("jlopencv_cv_KAZE_getDefaultName", [](cv::Ptr<KAZE> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_AKAZE_getDefaultName", [](cv::Ptr<AKAZE> &cobj) { auto retval = cobj->getDefaultName();  return retval; });
    ...
    mod.method("jlopencv_cv_DescriptorMatcher_create", [](cv::Ptr<DescriptorMatcher> &cobj, DescriptorMatcher_MatcherType &matcherType) { auto retval = cv::DescriptorMatcher::create(matcherType); return retval; });
    mod.add_type<cv::BFMatcher>("BFMatcher", jlcxx::julia_base_type<cv::DescriptorMatcher>())
        .constructor<const int &, const bool &>()

        ;
    mod.method("jlopencv_cv_BFMatcher_create", [](cv::Ptr<BFMatcher> &cobj, int &normType, bool &crossCheck) { auto retval = cv::BFMatcher::create(normType, crossCheck); return retval; });
    mod.add_type<cv::FlannBasedMatcher>("FlannBasedMatcher", jlcxx::julia_base_type<cv::DescriptorMatcher>())
        ...
        ;
    mod.method("jlopencv_cv_FlannBasedMatcher_create", [](cv::Ptr<FlannBasedMatcher> &cobj) { auto retval = cv::FlannBasedMatcher::create(); return retval; });
    ...
    mod.method("jlopencv_cv_BOWImgDescriptorExtractor_descriptorType", [](BOWImgDescriptorExtractor &cobj) { auto retval = cobj.descriptorType();  return retval; });
    ...
    mod.method("jlopencv_cv_DenseOpticalFlow_collectGarbage", [](cv::Ptr<DenseOpticalFlow> &cobj) { cobj->collectGarbage();  ; });
    mod.add_type<cv::SparseOpticalFlow>("SparseOpticalFlow", jlcxx::julia_base_type<cv::Algorithm>())

        ;
    mod.method("jlopencv_cv_SparseOpticalFlow_calc", [](cv::Ptr<SparseOpticalFlow> &cobj, Mat &prevImg, Mat &nextImg, Mat &prevPts, Mat &nextPts, Mat &status, Mat &err) { cobj->calc(prevImg, nextImg, prevPts, nextPts, status, err);  return make_tuple<Mat,Mat,Mat>(nextPts,status,err); });
    mod.method("jlopencv_cv_SparseOpticalFlow_calc", [](cv::Ptr<SparseOpticalFlow> &cobj, UMat &prevImg, UMat &nextImg, UMat &prevPts, UMat &nextPts, UMat &status, UMat &err) { cobj->calc(prevImg, nextImg, prevPts, nextPts, status, err);  return make_tuple<UMat,UMat,UMat>(nextPts,status,err); });
    ...
    mod.add_type<cv::VariationalRefinement>("VariationalRefinement", jlcxx::julia_base_type<cv::DenseOpticalFlow>())
        ...
        ;
    mod.method("jlopencv_cv_VariationalRefinement_calcUV", [](cv::Ptr<VariationalRefinement> &cobj, Mat &I0, Mat &I1, Mat &flow_u, Mat &flow_v) { cobj->calcUV(I0, I1, flow_u, flow_v);  return make_tuple<Mat,Mat>(flow_u,flow_v); });
    mod.method("jlopencv_cv_VariationalRefinement_calcUV", [](cv::Ptr<VariationalRefinement> &cobj, UMat &I0, UMat &I1, UMat &flow_u, UMat &flow_v) { cobj->calcUV(I0, I1, flow_u, flow_v);  return make_tuple<UMat,UMat>(flow_u,flow_v); });
    ...
    mod.method("jlopencv_cv_VariationalRefinement_create", [](cv::Ptr<VariationalRefinement> &cobj) { auto retval = cv::VariationalRefinement::create(); return retval; });
    ...
    mod.method("jlopencv_cv_DISOpticalFlow_create", [](cv::Ptr<DISOpticalFlow> &cobj, int &preset) { auto retval = cv::DISOpticalFlow::create(preset); return retval; });
    ...
    mod.method("jlopencv_cv_SparsePyrLKOpticalFlow_create", [](cv::Ptr<SparsePyrLKOpticalFlow> &cobj, Size &winSize, int &maxLevel, TermCriteria &crit, int &flags, double &minEigThreshold) { auto retval = cv::SparsePyrLKOpticalFlow::create(winSize, maxLevel, crit, flags, minEigThreshold); return retval; });
    ...
    mod.method("jlopencv_cv_BackgroundSubtractor_getBackgroundImage", [](cv::Ptr<BackgroundSubtractor> &cobj, UMat &backgroundImage) { cobj->getBackgroundImage(backgroundImage);  return backgroundImage; });
    ...
    mod.method("jlopencv_cv_BackgroundSubtractorMOG2_apply", [](cv::Ptr<BackgroundSubtractorMOG2> &cobj, UMat &image, UMat &fgmask, double &learningRate) { cobj->apply(image, fgmask, learningRate);  return fgmask; });
    ...
    mod.method("jlopencv_cv_BackgroundSubtractorKNN_setShadowThreshold", [](cv::Ptr<BackgroundSubtractorKNN> &cobj, double &threshold) { cobj->setShadowThreshold(threshold);  ; });
    ...
    mod.method("jlopencv_cv_CascadeClassifier_convert", [](CascadeClassifier &cobj, String &oldcascade, String &newcascade) { auto retval = cv::CascadeClassifier::convert(oldcascade, newcascade); return retval; });
    ...
    mod.method("jlopencv_cv_HOGDescriptor_computeGradient", [](HOGDescriptor &cobj, Mat &img, Mat &grad, Mat &angleOfs, Size &paddingTL, Size &paddingBR) { cobj.computeGradient(img, grad, angleOfs, paddingTL, paddingBR);  return make_tuple<Mat,Mat>(grad,angleOfs); });
    mod.method("jlopencv_cv_HOGDescriptor_computeGradient", [](HOGDescriptor &cobj, UMat &img, UMat &grad, UMat &angleOfs, Size &paddingTL, Size &paddingBR) { cobj.computeGradient(img, grad, angleOfs, paddingTL, paddingBR);  return make_tuple<UMat,UMat>(grad,angleOfs); });
    ...
    mod.method("jlopencv_cv_HOGDescriptor_getDaimlerPeopleDetector", [](HOGDescriptor &cobj) { auto retval = cv::HOGDescriptor::getDaimlerPeopleDetector(); return retval; });
    ...
    mod.method("jlopencv_cv_QRCodeDetector_detect", [](QRCodeDetector &cobj, Mat &img, Mat &points) { auto retval = cobj.detect(img, points);  return make_tuple<bool,Mat>(retval,points); });
    mod.method("jlopencv_cv_QRCodeDetector_detect", [](QRCodeDetector &cobj, UMat &img, UMat &points) { auto retval = cobj.detect(img, points);  return make_tuple<bool,UMat>(retval,points); });
    mod.method("jlopencv_cv_QRCodeDetector_decode", [](QRCodeDetector &cobj, Mat &img, Mat &points, Mat &straight_qrcode) { auto retval = cobj.decode(img, points, straight_qrcode);  return make_tuple<std::string,Mat>(retval,straight_qrcode); });
    mod.method("jlopencv_cv_QRCodeDetector_decode", [](QRCodeDetector &cobj, UMat &img, UMat &points, UMat &straight_qrcode) { auto retval = cobj.decode(img, points, straight_qrcode);  return make_tuple<std::string,UMat>(retval,straight_qrcode); });
    mod.method("jlopencv_cv_QRCodeDetector_detectAndDecode", [](QRCodeDetector &cobj, Mat &img, Mat &points, Mat &straight_qrcode) { auto retval = cobj.detectAndDecode(img, points, straight_qrcode);  return make_tuple<std::string,Mat,Mat>(retval,points,straight_qrcode); });
    mod.method("jlopencv_cv_QRCodeDetector_detectAndDecode", [](QRCodeDetector &cobj, UMat &img, UMat &points, UMat &straight_qrcode) { auto retval = cobj.detectAndDecode(img, points, straight_qrcode);  return make_tuple<std::string,UMat,UMat>(retval,points,straight_qrcode); });
    mod.method("jlopencv_cv_QRCodeDetector_detectMulti", [](QRCodeDetector &cobj, Mat &img, Mat &points) { auto retval = cobj.detectMulti(img, points);  return make_tuple<bool,Mat>(retval,points); });
    mod.method("jlopencv_cv_QRCodeDetector_detectMulti", [](QRCodeDetector &cobj, UMat &img, UMat &points) { auto retval = cobj.detectMulti(img, points);  return make_tuple<bool,UMat>(retval,points); });
    mod.method("jlopencv_cv_QRCodeDetector_decodeMulti", [](QRCodeDetector &cobj, Mat &img, Mat &points) {vector<string> decoded_info;vector<Mat> straight_qrcode; auto retval = cobj.decodeMulti(img, points, decoded_info, straight_qrcode);  return make_tuple<bool,vector<string>,vector<Mat>>(retval,decoded_info,straight_qrcode); });
    mod.method("jlopencv_cv_QRCodeDetector_decodeMulti", [](QRCodeDetector &cobj, UMat &img, UMat &points) {vector<string> decoded_info;vector<UMat> straight_qrcode; auto retval = cobj.decodeMulti(img, points, decoded_info, straight_qrcode);  return make_tuple<bool,vector<string>,vector<UMat>>(retval,decoded_info,straight_qrcode); });
    ...
    mod.method("jlopencv_cv_VideoCapture_retrieve", [](VideoCapture &cobj, Mat &image, int &flag) { auto retval = cobj.retrieve(image, flag);  return make_tuple<bool,Mat>(retval,image); });
    mod.method("jlopencv_cv_VideoCapture_retrieve", [](VideoCapture &cobj, UMat &image, int &flag) { auto retval = cobj.retrieve(image, flag);  return make_tuple<bool,UMat>(retval,image); });
    mod.method("jlopencv_cv_VideoCapture_read", [](VideoCapture &cobj, Mat &image) { auto retval = cobj.read(image);  return make_tuple<bool,Mat>(retval,image); });
    mod.method("jlopencv_cv_VideoCapture_read", [](VideoCapture &cobj, UMat &image) { auto retval = cobj.read(image);  return make_tuple<bool,UMat>(retval,image); });
    ...
    mod.method("jlopencv_cv_VideoCapture_getExceptionMode", [](VideoCapture &cobj) { auto retval = cobj.getExceptionMode();  return retval; });
    ...
    mod.method("jlopencv_cv_meanStdDev", [](Mat &src, Mat &mean, Mat &stddev, Mat &mask) { cv::meanStdDev(src, mean, stddev, mask); return make_tuple<Mat,Mat>(mean,stddev); });
    mod.method("jlopencv_cv_meanStdDev", [](UMat &src, UMat &mean, UMat &stddev, UMat &mask) { cv::meanStdDev(src, mean, stddev, mask); return make_tuple<UMat,UMat>(mean,stddev); });
    ...
    mod.method("jlopencv_cv_batchDistance", [](Mat &src1, Mat &src2, int &dtype, Mat &dist, Mat &nidx, int &normType, int &K, Mat &mask, int &update, bool &crosscheck) { cv::batchDistance(src1, src2, dist, dtype, nidx, normType, K, mask, update, crosscheck); return make_tuple<Mat,Mat>(dist,nidx); });
    mod.method("jlopencv_cv_batchDistance", [](UMat &src1, UMat &src2, int &dtype, UMat &dist, UMat &nidx, int &normType, int &K, UMat &mask, int &update, bool &crosscheck) { cv::batchDistance(src1, src2, dist, dtype, nidx, normType, K, mask, update, crosscheck); return make_tuple<UMat,UMat>(dist,nidx); });
    ...
    mod.method("jlopencv_cv_minMaxLoc", [](Mat &src, Mat &mask) {double minVal;double maxVal;Point minLoc;Point maxLoc; cv::minMaxLoc(src, minVal, maxVal, minLoc, maxLoc, mask); return make_tuple<double,double,Point,Point>(minVal,maxVal,minLoc,maxLoc); });
    mod.method("jlopencv_cv_minMaxLoc", [](UMat &src, UMat &mask) {double minVal;double maxVal;Point minLoc;Point maxLoc; cv::minMaxLoc(src, minVal, maxVal, minLoc, maxLoc, mask); return make_tuple<double,double,Point,Point>(minVal,maxVal,minLoc,maxLoc); });
    ...
    mod.method("jlopencv_cv_polarToCart", [](Mat &magnitude, Mat &angle, Mat &x, Mat &y, bool &angleInDegrees) { cv::polarToCart(magnitude, angle, x, y, angleInDegrees); return make_tuple<Mat,Mat>(x,y); });
    mod.method("jlopencv_cv_polarToCart", [](UMat &magnitude, UMat &angle, UMat &x, UMat &y, bool &angleInDegrees) { cv::polarToCart(magnitude, angle, x, y, angleInDegrees); return make_tuple<UMat,UMat>(x,y); });
    mod.method("jlopencv_cv_cartToPolar", [](Mat &x, Mat &y, Mat &magnitude, Mat &angle, bool &angleInDegrees) { cv::cartToPolar(x, y, magnitude, angle, angleInDegrees); return make_tuple<Mat,Mat>(magnitude,angle); });
    mod.method("jlopencv_cv_cartToPolar", [](UMat &x, UMat &y, UMat &magnitude, UMat &angle, bool &angleInDegrees) { cv::cartToPolar(x, y, magnitude, angle, angleInDegrees); return make_tuple<UMat,UMat>(magnitude,angle); });
    ...
    mod.method("jlopencv_cv_checkRange", [](Mat &a, bool &quiet, double &minVal, double &maxVal) {Point pos; auto retval = cv::checkRange(a, quiet, pos, minVal, maxVal); return make_tuple<bool,Point>(retval,pos); });
    mod.method("jlopencv_cv_checkRange", [](UMat &a, bool &quiet, double &minVal, double &maxVal) {Point pos; auto retval = cv::checkRange(a, quiet, pos, minVal, maxVal); return make_tuple<bool,Point>(retval,pos); });
    ...
    mod.method("jlopencv_cv_invert", [](Mat &src, Mat &dst, int &flags) { auto retval = cv::invert(src, dst, flags); return make_tuple<double,Mat>(retval,dst); });
    mod.method("jlopencv_cv_invert", [](UMat &src, UMat &dst, int &flags) { auto retval = cv::invert(src, dst, flags); return make_tuple<double,UMat>(retval,dst); });
    mod.method("jlopencv_cv_solve", [](Mat &src1, Mat &src2, Mat &dst, int &flags) { auto retval = cv::solve(src1, src2, dst, flags); return make_tuple<bool,Mat>(retval,dst); });
    mod.method("jlopencv_cv_solve", [](UMat &src1, UMat &src2, UMat &dst, int &flags) { auto retval = cv::solve(src1, src2, dst, flags); return make_tuple<bool,UMat>(retval,dst); });
    ...
    mod.method("jlopencv_cv_solveCubic", [](Mat &coeffs, Mat &roots) { auto retval = cv::solveCubic(coeffs, roots); return make_tuple<int,Mat>(retval,roots); });
    mod.method("jlopencv_cv_solveCubic", [](UMat &coeffs, UMat &roots) { auto retval = cv::solveCubic(coeffs, roots); return make_tuple<int,UMat>(retval,roots); });
    mod.method("jlopencv_cv_solvePoly", [](Mat &coeffs, Mat &roots, int &maxIters) { auto retval = cv::solvePoly(coeffs, roots, maxIters); return make_tuple<double,Mat>(retval,roots); });
    mod.method("jlopencv_cv_solvePoly", [](UMat &coeffs, UMat &roots, int &maxIters) { auto retval = cv::solvePoly(coeffs, roots, maxIters); return make_tuple<double,UMat>(retval,roots); });
    mod.method("jlopencv_cv_eigen", [](Mat &src, Mat &eigenvalues, Mat &eigenvectors) { auto retval = cv::eigen(src, eigenvalues, eigenvectors); return make_tuple<bool,Mat,Mat>(retval,eigenvalues,eigenvectors); });
    mod.method("jlopencv_cv_eigen", [](UMat &src, UMat &eigenvalues, UMat &eigenvectors) { auto retval = cv::eigen(src, eigenvalues, eigenvectors); return make_tuple<bool,UMat,UMat>(retval,eigenvalues,eigenvectors); });
    mod.method("jlopencv_cv_eigenNonSymmetric", [](Mat &src, Mat &eigenvalues, Mat &eigenvectors) { cv::eigenNonSymmetric(src, eigenvalues, eigenvectors); return make_tuple<Mat,Mat>(eigenvalues,eigenvectors); });
    mod.method("jlopencv_cv_eigenNonSymmetric", [](UMat &src, UMat &eigenvalues, UMat &eigenvectors) { cv::eigenNonSymmetric(src, eigenvalues, eigenvectors); return make_tuple<UMat,UMat>(eigenvalues,eigenvectors); });
    mod.method("jlopencv_cv_calcCovarMatrix", [](Mat &samples, Mat &mean, int &flags, Mat &covar, int &ctype) { cv::calcCovarMatrix(samples, covar, mean, flags, ctype); return make_tuple<Mat,Mat>(covar,mean); });
    mod.method("jlopencv_cv_calcCovarMatrix", [](UMat &samples, UMat &mean, int &flags, UMat &covar, int &ctype) { cv::calcCovarMatrix(samples, covar, mean, flags, ctype); return make_tuple<UMat,UMat>(covar,mean); });
    mod.method("jlopencv_cv_PCACompute", [](Mat &data, Mat &mean, Mat &eigenvectors, int &maxComponents) { cv::PCACompute(data, mean, eigenvectors, maxComponents); return make_tuple<Mat,Mat>(mean,eigenvectors); });
    mod.method("jlopencv_cv_PCACompute", [](UMat &data, UMat &mean, UMat &eigenvectors, int &maxComponents) { cv::PCACompute(data, mean, eigenvectors, maxComponents); return make_tuple<UMat,UMat>(mean,eigenvectors); });
    mod.method("jlopencv_cv_PCACompute", [](Mat &data, Mat &mean, double &retainedVariance, Mat &eigenvectors) { cv::PCACompute(data, mean, eigenvectors, retainedVariance); return make_tuple<Mat,Mat>(mean,eigenvectors); });
    mod.method("jlopencv_cv_PCACompute", [](UMat &data, UMat &mean, double &retainedVariance, UMat &eigenvectors) { cv::PCACompute(data, mean, eigenvectors, retainedVariance); return make_tuple<UMat,UMat>(mean,eigenvectors); });
    mod.method("jlopencv_cv_PCACompute2", [](Mat &data, Mat &mean, Mat &eigenvectors, Mat &eigenvalues, int &maxComponents) { cv::PCACompute(data, mean, eigenvectors, eigenvalues, maxComponents); return make_tuple<Mat,Mat,Mat>(mean,eigenvectors,eigenvalues); });
    mod.method("jlopencv_cv_PCACompute2", [](UMat &data, UMat &mean, UMat &eigenvectors, UMat &eigenvalues, int &maxComponents) { cv::PCACompute(data, mean, eigenvectors, eigenvalues, maxComponents); return make_tuple<UMat,UMat,UMat>(mean,eigenvectors,eigenvalues); });
    mod.method("jlopencv_cv_PCACompute2", [](Mat &data, Mat &mean, double &retainedVariance, Mat &eigenvectors, Mat &eigenvalues) { cv::PCACompute(data, mean, eigenvectors, eigenvalues, retainedVariance); return make_tuple<Mat,Mat,Mat>(mean,eigenvectors,eigenvalues); });
    mod.method("jlopencv_cv_PCACompute2", [](UMat &data, UMat &mean, double &retainedVariance, UMat &eigenvectors, UMat &eigenvalues) { cv::PCACompute(data, mean, eigenvectors, eigenvalues, retainedVariance); return make_tuple<UMat,UMat,UMat>(mean,eigenvectors,eigenvalues); });
    ...
    mod.method("jlopencv_cv_SVDecomp", [](Mat &src, Mat &w, Mat &u, Mat &vt, int &flags) { cv::SVDecomp(src, w, u, vt, flags); return make_tuple<Mat,Mat,Mat>(w,u,vt); });
    mod.method("jlopencv_cv_SVDecomp", [](UMat &src, UMat &w, UMat &u, UMat &vt, int &flags) { cv::SVDecomp(src, w, u, vt, flags); return make_tuple<UMat,UMat,UMat>(w,u,vt); });
    ...
    mod.method("jlopencv_cv_kmeans", [](Mat &data, int &K, Mat &bestLabels, TermCriteria &criteria, int &attempts, int &flags, Mat &centers) { auto retval = cv::kmeans(data, K, bestLabels, criteria, attempts, flags, centers); return make_tuple<double,Mat,Mat>(retval,bestLabels,centers); });
    mod.method("jlopencv_cv_kmeans", [](UMat &data, int &K, UMat &bestLabels, TermCriteria &criteria, int &attempts, int &flags, UMat &centers) { auto retval = cv::kmeans(data, K, bestLabels, criteria, attempts, flags, centers); return make_tuple<double,UMat,UMat>(retval,bestLabels,centers); });
    ...
    mod.method("jlopencv_cv_getDerivKernels", [](int &dx, int &dy, int &ksize, Mat &kx, Mat &ky, bool &normalize, int &ktype) { cv::getDerivKernels(kx, ky, dx, dy, ksize, normalize, ktype); return make_tuple<Mat,Mat>(kx,ky); });
    mod.method("jlopencv_cv_getDerivKernels", [](int &dx, int &dy, int &ksize, UMat &kx, UMat &ky, bool &normalize, int &ktype) { cv::getDerivKernels(kx, ky, dx, dy, ksize, normalize, ktype); return make_tuple<UMat,UMat>(kx,ky); });
    ...
    mod.method("jlopencv_cv_spatialGradient", [](Mat &src, Mat &dx, Mat &dy, int &ksize, int &borderType) { cv::spatialGradient(src, dx, dy, ksize, borderType); return make_tuple<Mat,Mat>(dx,dy); });
    mod.method("jlopencv_cv_spatialGradient", [](UMat &src, UMat &dx, UMat &dy, int &ksize, int &borderType) { cv::spatialGradient(src, dx, dy, ksize, borderType); return make_tuple<UMat,UMat>(dx,dy); });
    ...
    mod.method("jlopencv_cv_convertMaps", [](Mat &map1, Mat &map2, int &dstmap1type, Mat &dstmap1, Mat &dstmap2, bool &nninterpolation) { cv::convertMaps(map1, map2, dstmap1, dstmap2, dstmap1type, nninterpolation); return make_tuple<Mat,Mat>(dstmap1,dstmap2); });
    mod.method("jlopencv_cv_convertMaps", [](UMat &map1, UMat &map2, int &dstmap1type, UMat &dstmap1, UMat &dstmap2, bool &nninterpolation) { cv::convertMaps(map1, map2, dstmap1, dstmap2, dstmap1type, nninterpolation); return make_tuple<UMat,UMat>(dstmap1,dstmap2); });
    ...
    mod.method("jlopencv_cv_integral2", [](Mat &src, Mat &sum, Mat &sqsum, int &sdepth, int &sqdepth) { cv::integral(src, sum, sqsum, sdepth, sqdepth); return make_tuple<Mat,Mat>(sum,sqsum); });
    mod.method("jlopencv_cv_integral2", [](UMat &src, UMat &sum, UMat &sqsum, int &sdepth, int &sqdepth) { cv::integral(src, sum, sqsum, sdepth, sqdepth); return make_tuple<UMat,UMat>(sum,sqsum); });
    mod.method("jlopencv_cv_integral3", [](Mat &src, Mat &sum, Mat &sqsum, Mat &tilted, int &sdepth, int &sqdepth) { cv::integral(src, sum, sqsum, tilted, sdepth, sqdepth); return make_tuple<Mat,Mat,Mat>(sum,sqsum,tilted); });
    mod.method("jlopencv_cv_integral3", [](UMat &src, UMat &sum, UMat &sqsum, UMat &tilted, int &sdepth, int &sqdepth) { cv::integral(src, sum, sqsum, tilted, sdepth, sqdepth); return make_tuple<UMat,UMat,UMat>(sum,sqsum,tilted); });
    ...
    mod.method("jlopencv_cv_phaseCorrelate", [](Mat &src1, Mat &src2, Mat &window) {double response; auto retval = cv::phaseCorrelate(src1, src2, window, response); return make_tuple<Point2d,double>(retval,response); });
    mod.method("jlopencv_cv_phaseCorrelate", [](UMat &src1, UMat &src2, UMat &window) {double response; auto retval = cv::phaseCorrelate(src1, src2, window, response); return make_tuple<Point2d,double>(retval,response); });
    ...
    mod.method("jlopencv_cv_threshold", [](Mat &src, double &thresh, double &maxval, int &type, Mat &dst) { auto retval = cv::threshold(src, dst, thresh, maxval, type); return make_tuple<double,Mat>(retval,dst); });
    mod.method("jlopencv_cv_threshold", [](UMat &src, double &thresh, double &maxval, int &type, UMat &dst) { auto retval = cv::threshold(src, dst, thresh, maxval, type); return make_tuple<double,UMat>(retval,dst); });
    ...
    mod.method("jlopencv_cv_EMD", [](Mat &signature1, Mat &signature2, int &distType, Mat &cost, Ptr<float> &lowerBound, Mat &flow) { auto retval = cv::wrapperEMD(signature1, signature2, distType, cost, lowerBound, flow); return make_tuple<float,Ptr<float>,Mat>(retval,lowerBound,flow); });
    mod.method("jlopencv_cv_EMD", [](UMat &signature1, UMat &signature2, int &distType, UMat &cost, Ptr<float> &lowerBound, UMat &flow) { auto retval = cv::wrapperEMD(signature1, signature2, distType, cost, lowerBound, flow); return make_tuple<float,Ptr<float>,UMat>(retval,lowerBound,flow); });
    ...
    mod.method("jlopencv_cv_grabCut", [](Mat &img, Mat &mask, Rect &rect, Mat &bgdModel, Mat &fgdModel, int &iterCount, int &mode) { cv::grabCut(img, mask, rect, bgdModel, fgdModel, iterCount, mode); return make_tuple<Mat,Mat,Mat>(mask,bgdModel,fgdModel); });
    mod.method("jlopencv_cv_grabCut", [](UMat &img, UMat &mask, Rect &rect, UMat &bgdModel, UMat &fgdModel, int &iterCount, int &mode) { cv::grabCut(img, mask, rect, bgdModel, fgdModel, iterCount, mode); return make_tuple<UMat,UMat,UMat>(mask,bgdModel,fgdModel); });
    mod.method("jlopencv_cv_distanceTransformWithLabels", [](Mat &src, int &distanceType, int &maskSize, Mat &dst, Mat &labels, int &labelType) { cv::distanceTransform(src, dst, labels, distanceType, maskSize, labelType); return make_tuple<Mat,Mat>(dst,labels); });
    mod.method("jlopencv_cv_distanceTransformWithLabels", [](UMat &src, int &distanceType, int &maskSize, UMat &dst, UMat &labels, int &labelType) { cv::distanceTransform(src, dst, labels, distanceType, maskSize, labelType); return make_tuple<UMat,UMat>(dst,labels); });
    ...
    mod.method("jlopencv_cv_floodFill", [](Mat &image, Mat &mask, Point &seedPoint, Scalar &newVal, Scalar &loDiff, Scalar &upDiff, int &flags) {Rect rect; auto retval = cv::floodFill(image, mask, seedPoint, newVal, rect, loDiff, upDiff, flags); return make_tuple<int,Mat,Mat,Rect>(retval,image,mask,rect); });
    mod.method("jlopencv_cv_floodFill", [](UMat &image, UMat &mask, Point &seedPoint, Scalar &newVal, Scalar &loDiff, Scalar &upDiff, int &flags) {Rect rect; auto retval = cv::floodFill(image, mask, seedPoint, newVal, rect, loDiff, upDiff, flags); return make_tuple<int,UMat,UMat,Rect>(retval,image,mask,rect); });
    ...
    mod.method("jlopencv_cv_connectedComponentsWithAlgorithm", [](Mat &image, int &connectivity, int &ltype, int &ccltype, Mat &labels) { auto retval = cv::connectedComponents(image, labels, connectivity, ltype, ccltype); return make_tuple<int,Mat>(retval,labels); });
    mod.method("jlopencv_cv_connectedComponentsWithAlgorithm", [](UMat &image, int &connectivity, int &ltype, int &ccltype, UMat &labels) { auto retval = cv::connectedComponents(image, labels, connectivity, ltype, ccltype); return make_tuple<int,UMat>(retval,labels); });
    mod.method("jlopencv_cv_connectedComponents", [](Mat &image, Mat &labels, int &connectivity, int &ltype) { auto retval = cv::connectedComponents(image, labels, connectivity, ltype); return make_tuple<int,Mat>(retval,labels); });
    mod.method("jlopencv_cv_connectedComponents", [](UMat &image, UMat &labels, int &connectivity, int &ltype) { auto retval = cv::connectedComponents(image, labels, connectivity, ltype); return make_tuple<int,UMat>(retval,labels); });
    mod.method("jlopencv_cv_connectedComponentsWithStatsWithAlgorithm", [](Mat &image, int &connectivity, int &ltype, int &ccltype, Mat &labels, Mat &stats, Mat &centroids) { auto retval = cv::connectedComponentsWithStats(image, labels, stats, centroids, connectivity, ltype, ccltype); return make_tuple<int,Mat,Mat,Mat>(retval,labels,stats,centroids); });
    mod.method("jlopencv_cv_connectedComponentsWithStatsWithAlgorithm", [](UMat &image, int &connectivity, int &ltype, int &ccltype, UMat &labels, UMat &stats, UMat &centroids) { auto retval = cv::connectedComponentsWithStats(image, labels, stats, centroids, connectivity, ltype, ccltype); return make_tuple<int,UMat,UMat,UMat>(retval,labels,stats,centroids); });
    mod.method("jlopencv_cv_connectedComponentsWithStats", [](Mat &image, Mat &labels, Mat &stats, Mat &centroids, int &connectivity, int &ltype) { auto retval = cv::connectedComponentsWithStats(image, labels, stats, centroids, connectivity, ltype); return make_tuple<int,Mat,Mat,Mat>(retval,labels,stats,centroids); });
    mod.method("jlopencv_cv_connectedComponentsWithStats", [](UMat &image, UMat &labels, UMat &stats, UMat &centroids, int &connectivity, int &ltype) { auto retval = cv::connectedComponentsWithStats(image, labels, stats, centroids, connectivity, ltype); return make_tuple<int,UMat,UMat,UMat>(retval,labels,stats,centroids); });
    mod.method("jlopencv_cv_findContours", [](Mat &image, int &mode, int &method, Mat &hierarchy, Point &offset) {vector<Mat> contours; cv::findContours(image, contours, hierarchy, mode, method, offset); return make_tuple<vector<Mat>,Mat>(contours,hierarchy); });
    mod.method("jlopencv_cv_findContours", [](UMat &image, int &mode, int &method, UMat &hierarchy, Point &offset) {vector<UMat> contours; cv::findContours(image, contours, hierarchy, mode, method, offset); return make_tuple<vector<UMat>,UMat>(contours,hierarchy); });
    ...
    mod.method("jlopencv_cv_minEnclosingCircle", [](Mat &points) {Point2f center;float radius; cv::minEnclosingCircle(points, center, radius); return make_tuple<Point2f,float>(center,radius); });
    mod.method("jlopencv_cv_minEnclosingCircle", [](UMat &points) {Point2f center;float radius; cv::minEnclosingCircle(points, center, radius); return make_tuple<Point2f,float>(center,radius); });
    mod.method("jlopencv_cv_minEnclosingTriangle", [](Mat &points, Mat &triangle) { auto retval = cv::minEnclosingTriangle(points, triangle); return make_tuple<double,Mat>(retval,triangle); });
    mod.method("jlopencv_cv_minEnclosingTriangle", [](UMat &points, UMat &triangle) { auto retval = cv::minEnclosingTriangle(points, triangle); return make_tuple<double,UMat>(retval,triangle); });
    ...
    mod.method("jlopencv_cv_intersectConvexConvex", [](Mat &_p1, Mat &_p2, Mat &_p12, bool &handleNested) { auto retval = cv::intersectConvexConvex(_p1, _p2, _p12, handleNested); return make_tuple<float,Mat>(retval,_p12); });
    mod.method("jlopencv_cv_intersectConvexConvex", [](UMat &_p1, UMat &_p2, UMat &_p12, bool &handleNested) { auto retval = cv::intersectConvexConvex(_p1, _p2, _p12, handleNested); return make_tuple<float,UMat>(retval,_p12); });
    ...
    mod.method("jlopencv_cv_rotatedRectangleIntersection", [](RotatedRect &rect1, RotatedRect &rect2, Mat &intersectingRegion) { auto retval = cv::rotatedRectangleIntersection(rect1, rect2, intersectingRegion); return make_tuple<int,Mat>(retval,intersectingRegion); });
    mod.method("jlopencv_cv_rotatedRectangleIntersection", [](RotatedRect &rect1, RotatedRect &rect2, UMat &intersectingRegion) { auto retval = cv::rotatedRectangleIntersection(rect1, rect2, intersectingRegion); return make_tuple<int,UMat>(retval,intersectingRegion); });
    ...
    mod.method("jlopencv_cv_clipLine", [](Rect &imgRect, Point &pt1, Point &pt2) { auto retval = cv::clipLine(imgRect, pt1, pt2); return make_tuple<bool,Point,Point>(retval,pt1,pt2); });
    ...
    mod.method("jlopencv_cv_getTextSize", [](String &text, int &fontFace, double &fontScale, int &thickness) {int baseLine; auto retval = cv::getTextSize(text, fontFace, fontScale, thickness, baseLine); return make_tuple<Size,int>(retval,baseLine); });
    ...
    mod.method("jlopencv_cv_Rodrigues", [](Mat &src, Mat &dst, Mat &jacobian) { cv::Rodrigues(src, dst, jacobian); return make_tuple<Mat,Mat>(dst,jacobian); });
    mod.method("jlopencv_cv_Rodrigues", [](UMat &src, UMat &dst, UMat &jacobian) { cv::Rodrigues(src, dst, jacobian); return make_tuple<UMat,UMat>(dst,jacobian); });
    mod.method("jlopencv_cv_findHomography", [](Mat &srcPoints, Mat &dstPoints, int &method, double &ransacReprojThreshold, Mat &mask, int &maxIters, double &confidence) { auto retval = cv::findHomography(srcPoints, dstPoints, method, ransacReprojThreshold, mask, maxIters, confidence); return make_tuple<Mat,Mat>(retval,mask); });
    mod.method("jlopencv_cv_findHomography", [](UMat &srcPoints, UMat &dstPoints, int &method, double &ransacReprojThreshold, UMat &mask, int &maxIters, double &confidence) { auto retval = cv::findHomography(srcPoints, dstPoints, method, ransacReprojThreshold, mask, maxIters, confidence); return make_tuple<Mat,UMat>(retval,mask); });
    mod.method("jlopencv_cv_RQDecomp3x3", [](Mat &src, Mat &mtxR, Mat &mtxQ, Mat &Qx, Mat &Qy, Mat &Qz) { auto retval = cv::RQDecomp3x3(src, mtxR, mtxQ, Qx, Qy, Qz); return make_tuple<Vec3d,Mat,Mat,Mat,Mat,Mat>(retval,mtxR,mtxQ,Qx,Qy,Qz); });
    mod.method("jlopencv_cv_RQDecomp3x3", [](UMat &src, UMat &mtxR, UMat &mtxQ, UMat &Qx, UMat &Qy, UMat &Qz) { auto retval = cv::RQDecomp3x3(src, mtxR, mtxQ, Qx, Qy, Qz); return make_tuple<Vec3d,UMat,UMat,UMat,UMat,UMat>(retval,mtxR,mtxQ,Qx,Qy,Qz); });
    ...
    mod.method("jlopencv_cv_decomposeProjectionMatrix", [](UMat &projMatrix, UMat &cameraMatrix, UMat &rotMatrix, UMat &transVect, UMat &rotMatrixX, UMat &rotMatrixY, UMat &rotMatrixZ, UMat &eulerAngles) { cv::decomposeProjectionMatrix(projMatrix, cameraMatrix, rotMatrix, transVect, rotMatrixX, rotMatrixY, rotMatrixZ, eulerAngles); return make_tuple<UMat,UMat,UMat,UMat,UMat,UMat,UMat>(cameraMatrix,rotMatrix,transVect,rotMatrixX,rotMatrixY,rotMatrixZ,eulerAngles); });
    mod.method("jlopencv_cv_matMulDeriv", [](Mat &A, Mat &B, Mat &dABdA, Mat &dABdB) { cv::matMulDeriv(A, B, dABdA, dABdB); return make_tuple<Mat,Mat>(dABdA,dABdB); });
    mod.method("jlopencv_cv_matMulDeriv", [](UMat &A, UMat &B, UMat &dABdA, UMat &dABdB) { cv::matMulDeriv(A, B, dABdA, dABdB); return make_tuple<UMat,UMat>(dABdA,dABdB); });
    ...
    mod.method("jlopencv_cv_projectPoints", [](Mat &objectPoints, Mat &rvec, Mat &tvec, Mat &cameraMatrix, Mat &distCoeffs, Mat &imagePoints, Mat &jacobian, double &aspectRatio) { cv::projectPoints(objectPoints, rvec, tvec, cameraMatrix, distCoeffs, imagePoints, jacobian, aspectRatio); return make_tuple<Mat,Mat>(imagePoints,jacobian); });
    mod.method("jlopencv_cv_projectPoints", [](UMat &objectPoints, UMat &rvec, UMat &tvec, UMat &cameraMatrix, UMat &distCoeffs, UMat &imagePoints, UMat &jacobian, double &aspectRatio) { cv::projectPoints(objectPoints, rvec, tvec, cameraMatrix, distCoeffs, imagePoints, jacobian, aspectRatio); return make_tuple<UMat,UMat>(imagePoints,jacobian); });
    mod.method("jlopencv_cv_solvePnP", [](Mat &objectPoints, Mat &imagePoints, Mat &cameraMatrix, Mat &distCoeffs, Mat &rvec, Mat &tvec, bool &useExtrinsicGuess, int &flags) { auto retval = cv::solvePnP(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, useExtrinsicGuess, flags); return make_tuple<bool,Mat,Mat>(retval,rvec,tvec); });
    ...
    mod.method("jlopencv_cv_solveP3P", [](Mat &objectPoints, Mat &imagePoints, Mat &cameraMatrix, Mat &distCoeffs, int &flags) {vector<Mat> rvecs;vector<Mat> tvecs; auto retval = cv::solveP3P(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvecs, tvecs, flags); return make_tuple<int,vector<Mat>,vector<Mat>>(retval,rvecs,tvecs); });
    mod.method("jlopencv_cv_solveP3P", [](UMat &objectPoints, UMat &imagePoints, UMat &cameraMatrix, UMat &distCoeffs, int &flags) {vector<UMat> rvecs;vector<UMat> tvecs; auto retval = cv::solveP3P(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvecs, tvecs, flags); return make_tuple<int,vector<UMat>,vector<UMat>>(retval,rvecs,tvecs); });
    mod.method("jlopencv_cv_solvePnPRefineLM", [](Mat &objectPoints, Mat &imagePoints, Mat &cameraMatrix, Mat &distCoeffs, Mat &rvec, Mat &tvec, TermCriteria &criteria) { cv::solvePnPRefineLM(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, criteria); return make_tuple<Mat,Mat>(rvec,tvec); });
    mod.method("jlopencv_cv_solvePnPRefineLM", [](UMat &objectPoints, UMat &imagePoints, UMat &cameraMatrix, UMat &distCoeffs, UMat &rvec, UMat &tvec, TermCriteria &criteria) { cv::solvePnPRefineLM(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, criteria); return make_tuple<UMat,UMat>(rvec,tvec); });
    mod.method("jlopencv_cv_solvePnPRefineVVS", [](Mat &objectPoints, Mat &imagePoints, Mat &cameraMatrix, Mat &distCoeffs, Mat &rvec, Mat &tvec, TermCriteria &criteria, double &VVSlambda) { cv::solvePnPRefineVVS(objectPoints, imagePoints, cameraMatrix, distCoeffs, rvec, tvec, criteria, VVSlambda); return make_tuple<Mat,Mat>(rvec,tvec); });
    ...
    mod.method("jlopencv_cv_findChessboardCorners", [](Mat &image, Size &patternSize, Mat &corners, int &flags) { auto retval = cv::findChessboardCorners(image, patternSize, corners, flags); return make_tuple<bool,Mat>(retval,corners); });
    mod.method("jlopencv_cv_findChessboardCorners", [](UMat &image, Size &patternSize, UMat &corners, int &flags) { auto retval = cv::findChessboardCorners(image, patternSize, corners, flags); return make_tuple<bool,UMat>(retval,corners); });
    ...
    mod.method("jlopencv_cv_findChessboardCornersSB", [](Mat &image, Size &patternSize, Mat &corners, int &flags) { auto retval = cv::findChessboardCornersSB(image, patternSize, corners, flags); return make_tuple<bool,Mat>(retval,corners); });
    mod.method("jlopencv_cv_findChessboardCornersSB", [](UMat &image, Size &patternSize, UMat &corners, int &flags) { auto retval = cv::findChessboardCornersSB(image, patternSize, corners, flags); return make_tuple<bool,UMat>(retval,corners); });
    mod.method("jlopencv_cv_find4QuadCornerSubpix", [](Mat &img, Mat &corners, Size &region_size) { auto retval = cv::find4QuadCornerSubpix(img, corners, region_size); return make_tuple<bool,Mat>(retval,corners); });
    mod.method("jlopencv_cv_find4QuadCornerSubpix", [](UMat &img, UMat &corners, Size &region_size) { auto retval = cv::find4QuadCornerSubpix(img, corners, region_size); return make_tuple<bool,UMat>(retval,corners); });
    ...
    mod.method("jlopencv_cv_findCirclesGrid", [](Mat &image, Size &patternSize, int &flags, Ptr<FeatureDetector> &blobDetector, CirclesGridFinderParameters &parameters, Mat &centers) { auto retval = cv::findCirclesGrid(image, patternSize, centers, flags, blobDetector, parameters); return make_tuple<bool,Mat>(retval,centers); });
    mod.method("jlopencv_cv_findCirclesGrid", [](UMat &image, Size &patternSize, int &flags, Ptr<FeatureDetector> &blobDetector, CirclesGridFinderParameters &parameters, UMat &centers) { auto retval = cv::findCirclesGrid(image, patternSize, centers, flags, blobDetector, parameters); return make_tuple<bool,UMat>(retval,centers); });
    mod.method("jlopencv_cv_findCirclesGrid", [](Mat &image, Size &patternSize, Mat &centers, int &flags, Ptr<FeatureDetector> &blobDetector) { auto retval = cv::findCirclesGrid(image, patternSize, centers, flags, blobDetector); return make_tuple<bool,Mat>(retval,centers); });
    mod.method("jlopencv_cv_findCirclesGrid", [](UMat &image, Size &patternSize, UMat &centers, int &flags, Ptr<FeatureDetector> &blobDetector) { auto retval = cv::findCirclesGrid(image, patternSize, centers, flags, blobDetector); return make_tuple<bool,UMat>(retval,centers); });
    ...
    mod.method("jlopencv_cv_stereoRectifyUncalibrated", [](Mat &points1, Mat &points2, Mat &F, Size &imgSize, Mat &H1, Mat &H2, double &threshold) { auto retval = cv::stereoRectifyUncalibrated(points1, points2, F, imgSize, H1, H2, threshold); return make_tuple<bool,Mat,Mat>(retval,H1,H2); });
    mod.method("jlopencv_cv_stereoRectifyUncalibrated", [](UMat &points1, UMat &points2, UMat &F, Size &imgSize, UMat &H1, UMat &H2, double &threshold) { auto retval = cv::stereoRectifyUncalibrated(points1, points2, F, imgSize, H1, H2, threshold); return make_tuple<bool,UMat,UMat>(retval,H1,H2); });
    ...
    mod.method("jlopencv_cv_findFundamentalMat", [](Mat &points1, Mat &points2, int &method, double &ransacReprojThreshold, double &confidence, Mat &mask) { auto retval = cv::findFundamentalMat(points1, points2, method, ransacReprojThreshold, confidence, mask); return make_tuple<Mat,Mat>(retval,mask); });
    mod.method("jlopencv_cv_findFundamentalMat", [](UMat &points1, UMat &points2, int &method, double &ransacReprojThreshold, double &confidence, UMat &mask) { auto retval = cv::findFundamentalMat(points1, points2, method, ransacReprojThreshold, confidence, mask); return make_tuple<Mat,UMat>(retval,mask); });
    mod.method("jlopencv_cv_findEssentialMat", [](Mat &points1, Mat &points2, Mat &cameraMatrix, int &method, double &prob, double &threshold, Mat &mask) { auto retval = cv::findEssentialMat(points1, points2, cameraMatrix, method, prob, threshold, mask); return make_tuple<Mat,Mat>(retval,mask); });
    mod.method("jlopencv_cv_findEssentialMat", [](UMat &points1, UMat &points2, UMat &cameraMatrix, int &method, double &prob, double &threshold, UMat &mask) { auto retval = cv::findEssentialMat(points1, points2, cameraMatrix, method, prob, threshold, mask); return make_tuple<Mat,UMat>(retval,mask); });
    mod.method("jlopencv_cv_findEssentialMat", [](Mat &points1, Mat &points2, double &focal, Point2d &pp, int &method, double &prob, double &threshold, Mat &mask) { auto retval = cv::findEssentialMat(points1, points2, focal, pp, method, prob, threshold, mask); return make_tuple<Mat,Mat>(retval,mask); });
    mod.method("jlopencv_cv_findEssentialMat", [](UMat &points1, UMat &points2, double &focal, Point2d &pp, int &method, double &prob, double &threshold, UMat &mask) { auto retval = cv::findEssentialMat(points1, points2, focal, pp, method, prob, threshold, mask); return make_tuple<Mat,UMat>(retval,mask); });
    mod.method("jlopencv_cv_decomposeEssentialMat", [](Mat &E, Mat &R1, Mat &R2, Mat &t) { cv::decomposeEssentialMat(E, R1, R2, t); return make_tuple<Mat,Mat,Mat>(R1,R2,t); });
    mod.method("jlopencv_cv_decomposeEssentialMat", [](UMat &E, UMat &R1, UMat &R2, UMat &t) { cv::decomposeEssentialMat(E, R1, R2, t); return make_tuple<UMat,UMat,UMat>(R1,R2,t); });
    mod.method("jlopencv_cv_recoverPose", [](Mat &E, Mat &points1, Mat &points2, Mat &cameraMatrix, Mat &R, Mat &t, Mat &mask) { auto retval = cv::recoverPose(E, points1, points2, cameraMatrix, R, t, mask); return make_tuple<int,Mat,Mat,Mat>(retval,R,t,mask); });
    mod.method("jlopencv_cv_recoverPose", [](UMat &E, UMat &points1, UMat &points2, UMat &cameraMatrix, UMat &R, UMat &t, UMat &mask) { auto retval = cv::recoverPose(E, points1, points2, cameraMatrix, R, t, mask); return make_tuple<int,UMat,UMat,UMat>(retval,R,t,mask); });
    mod.method("jlopencv_cv_recoverPose", [](Mat &E, Mat &points1, Mat &points2, Mat &R, Mat &t, double &focal, Point2d &pp, Mat &mask) { auto retval = cv::recoverPose(E, points1, points2, R, t, focal, pp, mask); return make_tuple<int,Mat,Mat,Mat>(retval,R,t,mask); });
    mod.method("jlopencv_cv_recoverPose", [](UMat &E, UMat &points1, UMat &points2, UMat &R, UMat &t, double &focal, Point2d &pp, UMat &mask) { auto retval = cv::recoverPose(E, points1, points2, R, t, focal, pp, mask); return make_tuple<int,UMat,UMat,UMat>(retval,R,t,mask); });
    ...
    mod.method("jlopencv_cv_correctMatches", [](Mat &F, Mat &points1, Mat &points2, Mat &newPoints1, Mat &newPoints2) { cv::correctMatches(F, points1, points2, newPoints1, newPoints2); return make_tuple<Mat,Mat>(newPoints1,newPoints2); });
    mod.method("jlopencv_cv_correctMatches", [](UMat &F, UMat &points1, UMat &points2, UMat &newPoints1, UMat &newPoints2) { cv::correctMatches(F, points1, points2, newPoints1, newPoints2); return make_tuple<UMat,UMat>(newPoints1,newPoints2); });
    mod.method("jlopencv_cv_filterSpeckles", [](Mat &img, double &newVal, int &maxSpeckleSize, double &maxDiff, Mat &buf) { cv::filterSpeckles(img, newVal, maxSpeckleSize, maxDiff, buf); return make_tuple<Mat,Mat>(img,buf); });
    mod.method("jlopencv_cv_filterSpeckles", [](UMat &img, double &newVal, int &maxSpeckleSize, double &maxDiff, UMat &buf) { cv::filterSpeckles(img, newVal, maxSpeckleSize, maxDiff, buf); return make_tuple<UMat,UMat>(img,buf); });
    ...
    mod.method("jlopencv_cv_estimateAffine3D", [](Mat &src, Mat &dst, Mat &out, Mat &inliers, double &ransacThreshold, double &confidence) { auto retval = cv::estimateAffine3D(src, dst, out, inliers, ransacThreshold, confidence); return make_tuple<int,Mat,Mat>(retval,out,inliers); });
    mod.method("jlopencv_cv_estimateAffine3D", [](UMat &src, UMat &dst, UMat &out, UMat &inliers, double &ransacThreshold, double &confidence) { auto retval = cv::estimateAffine3D(src, dst, out, inliers, ransacThreshold, confidence); return make_tuple<int,UMat,UMat>(retval,out,inliers); });
    mod.method("jlopencv_cv_estimateAffine2D", [](Mat &from, Mat &to, Mat &inliers, int &method, double &ransacReprojThreshold, size_t &maxIters, double &confidence, size_t &refineIters) { auto retval = cv::estimateAffine2D(from, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters); return make_tuple<cv::Mat,Mat>(retval,inliers); });
    mod.method("jlopencv_cv_estimateAffine2D", [](UMat &from, UMat &to, UMat &inliers, int &method, double &ransacReprojThreshold, size_t &maxIters, double &confidence, size_t &refineIters) { auto retval = cv::estimateAffine2D(from, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters); return make_tuple<cv::Mat,UMat>(retval,inliers); });
    mod.method("jlopencv_cv_estimateAffinePartial2D", [](Mat &from, Mat &to, Mat &inliers, int &method, double &ransacReprojThreshold, size_t &maxIters, double &confidence, size_t &refineIters) { auto retval = cv::estimateAffinePartial2D(from, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters); return make_tuple<cv::Mat,Mat>(retval,inliers); });
    mod.method("jlopencv_cv_estimateAffinePartial2D", [](UMat &from, UMat &to, UMat &inliers, int &method, double &ransacReprojThreshold, size_t &maxIters, double &confidence, size_t &refineIters) { auto retval = cv::estimateAffinePartial2D(from, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters); return make_tuple<cv::Mat,UMat>(retval,inliers); });
    mod.method("jlopencv_cv_decomposeHomographyMat", [](Mat &H, Mat &K) {vector<Mat> rotations;vector<Mat> translations;vector<Mat> normals; auto retval = cv::decomposeHomographyMat(H, K, rotations, translations, normals); return make_tuple<int,vector<Mat>,vector<Mat>,vector<Mat>>(retval,rotations,translations,normals); });
    mod.method("jlopencv_cv_decomposeHomographyMat", [](UMat &H, UMat &K) {vector<UMat> rotations;vector<UMat> translations;vector<UMat> normals; auto retval = cv::decomposeHomographyMat(H, K, rotations, translations, normals); return make_tuple<int,vector<UMat>,vector<UMat>,vector<UMat>>(retval,rotations,translations,normals); });
    ...
    mod.method("jlopencv_cv_initUndistortRectifyMap", [](Mat &cameraMatrix, Mat &distCoeffs, Mat &R, Mat &newCameraMatrix, Size &size, int &m1type, Mat &map1, Mat &map2) { cv::initUndistortRectifyMap(cameraMatrix, distCoeffs, R, newCameraMatrix, size, m1type, map1, map2); return make_tuple<Mat,Mat>(map1,map2); });
    mod.method("jlopencv_cv_initUndistortRectifyMap", [](UMat &cameraMatrix, UMat &distCoeffs, UMat &R, UMat &newCameraMatrix, Size &size, int &m1type, UMat &map1, UMat &map2) { cv::initUndistortRectifyMap(cameraMatrix, distCoeffs, R, newCameraMatrix, size, m1type, map1, map2); return make_tuple<UMat,UMat>(map1,map2); });
    ...
    mod.method("jlopencv_cv_CamShift", [](Mat &probImage, Rect &window, TermCriteria &criteria) { auto retval = cv::CamShift(probImage, window, criteria); return make_tuple<RotatedRect,Rect>(retval,window); });
    mod.method("jlopencv_cv_CamShift", [](UMat &probImage, Rect &window, TermCriteria &criteria) { auto retval = cv::CamShift(probImage, window, criteria); return make_tuple<RotatedRect,Rect>(retval,window); });
    mod.method("jlopencv_cv_meanShift", [](Mat &probImage, Rect &window, TermCriteria &criteria) { auto retval = cv::meanShift(probImage, window, criteria); return make_tuple<int,Rect>(retval,window); });
    mod.method("jlopencv_cv_meanShift", [](UMat &probImage, Rect &window, TermCriteria &criteria) { auto retval = cv::meanShift(probImage, window, criteria); return make_tuple<int,Rect>(retval,window); });
    ...
    mod.method("jlopencv_cv_groupRectangles", [](vector<Rect> &rectList, int &groupThreshold, double &eps) {vector<int> weights; cv::groupRectangles(rectList, weights, groupThreshold, eps); return make_tuple<vector<Rect>,vector<int>>(rectList,weights); });
    ...
    mod.method("jlopencv_cv_imreadmulti", [](String &filename, int &flags) {vector<Mat> mats; auto retval = cv::imreadmulti(filename, mats, flags); return make_tuple<bool,vector<Mat>>(retval,mats); });
    mod.method("jlopencv_cv_imreadmulti", [](String &filename, int &flags) {vector<Mat> mats; auto retval = cv::imreadmulti(filename, mats, flags); return make_tuple<bool,vector<Mat>>(retval,mats); });
    ...
    mod.method("jlopencv_cv_imencode", [](String &ext, Mat &img, vector<int> &params) {vector<uchar> buf; auto retval = cv::imencode(ext, img, buf, params); return make_tuple<bool,vector<uchar>>(retval,buf); });
    mod.method("jlopencv_cv_imencode", [](String &ext, UMat &img, vector<int> &params) {vector<uchar> buf; auto retval = cv::imencode(ext, img, buf, params); return make_tuple<bool,vector<uchar>>(retval,buf); });
...
JLCXX_MODULE flann(jlcxx::Module &mod)
{
    ...
    mod.method("jlopencv_cv_flann_Index_knnSearch", [](Index &cobj, Mat &query, int &knn, Mat &indices, Mat &dists, SearchParams &params) { cobj.knnSearch(query, indices, dists, knn, params);  return make_tuple<Mat,Mat>(indices,dists); });
    mod.method("jlopencv_cv_flann_Index_knnSearch", [](Index &cobj, UMat &query, int &knn, UMat &indices, UMat &dists, SearchParams &params) { cobj.knnSearch(query, indices, dists, knn, params);  return make_tuple<UMat,UMat>(indices,dists); });
    mod.method("jlopencv_cv_flann_Index_radiusSearch", [](Index &cobj, Mat &query, double &radius, int &maxResults, Mat &indices, Mat &dists, SearchParams &params) { auto retval = cobj.radiusSearch(query, indices, dists, radius, maxResults, params);  return make_tuple<int,Mat,Mat>(retval,indices,dists); });
    mod.method("jlopencv_cv_flann_Index_radiusSearch", [](Index &cobj, UMat &query, double &radius, int &maxResults, UMat &indices, UMat &dists, SearchParams &params) { auto retval = cobj.radiusSearch(query, indices, dists, radius, maxResults, params);  return make_tuple<int,UMat,UMat>(retval,indices,dists); });
...
JLCXX_MODULE ml(jlcxx::Module &mod)
{
    ...
    mod.method("jlopencv_cv_ml_ParamGrid_create", [](ParamGrid &cobj, double &minVal, double &maxVal, double &logstep) { auto retval = cv::ml::ParamGrid::create(minVal, maxVal, logstep); return retval; });
    ...
    mod.method("jlopencv_cv_ml_TrainData_create", [](TrainData &cobj, UMat &samples, int &layout, UMat &responses, UMat &varIdx, UMat &sampleIdx, UMat &sampleWeights, UMat &varType) { auto retval = cv::ml::TrainData::create(samples, layout, responses, varIdx, sampleIdx, sampleWeights, varType); return retval; });
    ...
    mod.method("jlopencv_cv_ml_StatModel_calcError", [](cv::Ptr<StatModel> &cobj, Ptr<TrainData> &data, bool &test, Mat &resp) { auto retval = cobj->calcError(data, test, resp);  return make_tuple<float,Mat>(retval,resp); });
    mod.method("jlopencv_cv_ml_StatModel_calcError", [](cv::Ptr<StatModel> &cobj, Ptr<TrainData> &data, bool &test, UMat &resp) { auto retval = cobj->calcError(data, test, resp);  return make_tuple<float,UMat>(retval,resp); });
    mod.method("jlopencv_cv_ml_StatModel_predict", [](cv::Ptr<StatModel> &cobj, Mat &samples, Mat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,Mat>(retval,results); });
    mod.method("jlopencv_cv_ml_StatModel_predict", [](cv::Ptr<StatModel> &cobj, UMat &samples, UMat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,UMat>(retval,results); });
    mod.add_type<cv::ml::NormalBayesClassifier>("ml_NormalBayesClassifier", jlcxx::julia_base_type<cv::ml::StatModel>())

        ;
    mod.method("jlopencv_cv_ml_NormalBayesClassifier_predictProb", [](cv::Ptr<NormalBayesClassifier> &cobj, Mat &inputs, Mat &outputs, Mat &outputProbs, int &flags) { auto retval = cobj->predictProb(inputs, outputs, outputProbs, flags);  return make_tuple<float,Mat,Mat>(retval,outputs,outputProbs); });
    mod.method("jlopencv_cv_ml_NormalBayesClassifier_predictProb", [](cv::Ptr<NormalBayesClassifier> &cobj, UMat &inputs, UMat &outputs, UMat &outputProbs, int &flags) { auto retval = cobj->predictProb(inputs, outputs, outputProbs, flags);  return make_tuple<float,UMat,UMat>(retval,outputs,outputProbs); });
    ...
    mod.method("jlopencv_cv_ml_NormalBayesClassifier_load", [](cv::Ptr<NormalBayesClassifier> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::NormalBayesClassifier::load(filepath, nodeName); return retval; });
    ...
    mod.method("jlopencv_cv_ml_KNearest_findNearest", [](cv::Ptr<KNearest> &cobj, Mat &samples, int &k, Mat &results, Mat &neighborResponses, Mat &dist) { auto retval = cobj->findNearest(samples, k, results, neighborResponses, dist);  return make_tuple<float,Mat,Mat,Mat>(retval,results,neighborResponses,dist); });
    mod.method("jlopencv_cv_ml_KNearest_findNearest", [](cv::Ptr<KNearest> &cobj, UMat &samples, int &k, UMat &results, UMat &neighborResponses, UMat &dist) { auto retval = cobj->findNearest(samples, k, results, neighborResponses, dist);  return make_tuple<float,UMat,UMat,UMat>(retval,results,neighborResponses,dist); });
    mod.method("jlopencv_cv_ml_KNearest_create", [](cv::Ptr<KNearest> &cobj) { auto retval = cv::ml::KNearest::create(); return retval; });
    mod.method("jlopencv_cv_ml_KNearest_load", [](cv::Ptr<KNearest> &cobj, String &filepath) { auto retval = cv::ml::KNearest::load(filepath); return retval; });
    ...
    mod.method("jlopencv_cv_ml_SVM_getDecisionFunction", [](cv::Ptr<SVM> &cobj, int &i, Mat &alpha, Mat &svidx) { auto retval = cobj->getDecisionFunction(i, alpha, svidx);  return make_tuple<double,Mat,Mat>(retval,alpha,svidx); });
    mod.method("jlopencv_cv_ml_SVM_getDecisionFunction", [](cv::Ptr<SVM> &cobj, int &i, UMat &alpha, UMat &svidx) { auto retval = cobj->getDecisionFunction(i, alpha, svidx);  return make_tuple<double,UMat,UMat>(retval,alpha,svidx); });
    ...
    mod.method("jlopencv_cv_ml_SVM_load", [](cv::Ptr<SVM> &cobj, String &filepath) { auto retval = cv::ml::SVM::load(filepath); return retval; });
    ...
    mod.method("jlopencv_cv_ml_EM_getCovs", [](cv::Ptr<EM> &cobj) {vector<Mat> covs; cobj->getCovs(covs);  return covs; });
    mod.method("jlopencv_cv_ml_EM_predict", [](cv::Ptr<EM> &cobj, Mat &samples, Mat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,Mat>(retval,results); });
    mod.method("jlopencv_cv_ml_EM_predict", [](cv::Ptr<EM> &cobj, UMat &samples, UMat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,UMat>(retval,results); });
    mod.method("jlopencv_cv_ml_EM_predict2", [](cv::Ptr<EM> &cobj, Mat &sample, Mat &probs) { auto retval = cobj->predict2(sample, probs);  return make_tuple<Vec2d,Mat>(retval,probs); });
    mod.method("jlopencv_cv_ml_EM_predict2", [](cv::Ptr<EM> &cobj, UMat &sample, UMat &probs) { auto retval = cobj->predict2(sample, probs);  return make_tuple<Vec2d,UMat>(retval,probs); });
    mod.method("jlopencv_cv_ml_EM_trainEM", [](cv::Ptr<EM> &cobj, Mat &samples, Mat &logLikelihoods, Mat &labels, Mat &probs) { auto retval = cobj->trainEM(samples, logLikelihoods, labels, probs);  return make_tuple<bool,Mat,Mat,Mat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_trainEM", [](cv::Ptr<EM> &cobj, UMat &samples, UMat &logLikelihoods, UMat &labels, UMat &probs) { auto retval = cobj->trainEM(samples, logLikelihoods, labels, probs);  return make_tuple<bool,UMat,UMat,UMat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_trainE", [](cv::Ptr<EM> &cobj, Mat &samples, Mat &means0, Mat &covs0, Mat &weights0, Mat &logLikelihoods, Mat &labels, Mat &probs) { auto retval = cobj->trainE(samples, means0, covs0, weights0, logLikelihoods, labels, probs);  return make_tuple<bool,Mat,Mat,Mat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_trainE", [](cv::Ptr<EM> &cobj, UMat &samples, UMat &means0, UMat &covs0, UMat &weights0, UMat &logLikelihoods, UMat &labels, UMat &probs) { auto retval = cobj->trainE(samples, means0, covs0, weights0, logLikelihoods, labels, probs);  return make_tuple<bool,UMat,UMat,UMat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_trainM", [](cv::Ptr<EM> &cobj, Mat &samples, Mat &probs0, Mat &logLikelihoods, Mat &labels, Mat &probs) { auto retval = cobj->trainM(samples, probs0, logLikelihoods, labels, probs);  return make_tuple<bool,Mat,Mat,Mat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_trainM", [](cv::Ptr<EM> &cobj, UMat &samples, UMat &probs0, UMat &logLikelihoods, UMat &labels, UMat &probs) { auto retval = cobj->trainM(samples, probs0, logLikelihoods, labels, probs);  return make_tuple<bool,UMat,UMat,UMat>(retval,logLikelihoods,labels,probs); });
    mod.method("jlopencv_cv_ml_EM_create", [](cv::Ptr<EM> &cobj) { auto retval = cv::ml::EM::create(); return retval; });
    mod.method("jlopencv_cv_ml_EM_load", [](cv::Ptr<EM> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::EM::load(filepath, nodeName); return retval; });
    ...
    mod.method("jlopencv_cv_ml_DTrees_load", [](cv::Ptr<DTrees> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::DTrees::load(filepath, nodeName); return retval; });
    ...
    mod.method("jlopencv_cv_ml_RTrees_load", [](cv::Ptr<RTrees> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::RTrees::load(filepath, nodeName); return retval; });
    ...
    mod.method("jlopencv_cv_ml_Boost_load", [](cv::Ptr<Boost> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::Boost::load(filepath, nodeName); return retval; });
    ...
    mod.method("jlopencv_cv_ml_ANN_MLP_load", [](cv::Ptr<ANN_MLP> &cobj, String &filepath) { auto retval = cv::ml::ANN_MLP::load(filepath); return retval; });
    ...
    mod.method("jlopencv_cv_ml_LogisticRegression_predict", [](cv::Ptr<LogisticRegression> &cobj, Mat &samples, Mat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,Mat>(retval,results); });
    mod.method("jlopencv_cv_ml_LogisticRegression_predict", [](cv::Ptr<LogisticRegression> &cobj, UMat &samples, UMat &results, int &flags) { auto retval = cobj->predict(samples, results, flags);  return make_tuple<float,UMat>(retval,results); });
    ...
    mod.method("jlopencv_cv_ml_LogisticRegression_load", [](cv::Ptr<LogisticRegression> &cobj, String &filepath, String &nodeName) { auto retval = cv::ml::LogisticRegression::load(filepath, nodeName); return retval; });
...
JLCXX_MODULE fisheye(jlcxx::Module &mod)
{
    ...
    mod.method("jlopencv_cv_fisheye_projectPoints", [](Mat &objectPoints, Mat &rvec, Mat &tvec, Mat &K, Mat &D, Mat &imagePoints, double &alpha, Mat &jacobian) { cv::fisheye::projectPoints(objectPoints, imagePoints, rvec, tvec, K, D, alpha, jacobian); return make_tuple<Mat,Mat>(imagePoints,jacobian); });
    mod.method("jlopencv_cv_fisheye_projectPoints", [](UMat &objectPoints, UMat &rvec, UMat &tvec, UMat &K, UMat &D, UMat &imagePoints, double &alpha, UMat &jacobian) { cv::fisheye::projectPoints(objectPoints, imagePoints, rvec, tvec, K, D, alpha, jacobian); return make_tuple<UMat,UMat>(imagePoints,jacobian); });
    ...
    mod.method("jlopencv_cv_fisheye_initUndistortRectifyMap", [](Mat &K, Mat &D, Mat &R, Mat &P, Size &size, int &m1type, Mat &map1, Mat &map2) { cv::fisheye::initUndistortRectifyMap(K, D, R, P, size, m1type, map1, map2); return make_tuple<Mat,Mat>(map1,map2); });
    mod.method("jlopencv_cv_fisheye_initUndistortRectifyMap", [](UMat &K, UMat &D, UMat &R, UMat &P, Size &size, int &m1type, UMat &map1, UMat &map2) { cv::fisheye::initUndistortRectifyMap(K, D, R, P, size, m1type, map1, map2); return make_tuple<UMat,UMat>(map1,map2); });
