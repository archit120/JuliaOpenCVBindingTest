...
.method("jlopencv_ml_ParamGrid_get_logStep", [](const cv::ml::ParamGrid &cobj) {return cobj.logStep;});
    mod.method("jlopencv_cv_ml_ParamGrid_create",  [](double& minVal, double& maxVal, double& logstep) { auto retval = cv::ml::ParamGrid::create(minVal, maxVal, logstep); return retval;});mod.add_type<cv::ml::TrainData>("ml_TrainData")
...
;
    ...
    mod.method("jlopencv_cv_ml_TrainData_create",  [](UMat& samples, int& layout, UMat& responses, UMat& varIdx, UMat& sampleIdx, UMat& sampleWeights, UMat& varType) { auto retval = cv::ml::TrainData::create(samples, layout, responses, varIdx, sampleIdx, sampleWeights, varType); return retval;});mod.add_type<cv::ml::StatModel>("ml_StatModel", jlcxx::julia_base_type<cv::Algorithm>())
...
;
    ...
    mod.method("jlopencv_cv_ml_StatModel_predict",  [](cv::Ptr<StatModel>& cobj, UMat& samples, UMat& results, int& flags) { auto retval = cobj->cv::ml::StatModel::predict(samples, results, flags);  return make_tuple<float,UMat>(move(retval),move(results));});mod.add_type<cv::ml::NormalBayesClassifier>("ml_NormalBayesClassifier", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_NormalBayesClassifier_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::NormalBayesClassifier::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::KNearest>("ml_KNearest", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_KNearest_load",  [](String& filepath) { auto retval = cv::ml::KNearest::load(filepath); return retval;});mod.add_type<cv::ml::SVM>("ml_SVM", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_SVM_load",  [](String& filepath) { auto retval = cv::ml::SVM::load(filepath); return retval;});mod.add_type<cv::ml::EM>("ml_EM", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_EM_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::EM::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::DTrees>("ml_DTrees", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_DTrees_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::DTrees::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::RTrees>("ml_RTrees", jlcxx::julia_base_type<cv::ml::DTrees>())
...
;
    ...
    mod.method("jlopencv_cv_ml_RTrees_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::RTrees::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::Boost>("ml_Boost", jlcxx::julia_base_type<cv::ml::DTrees>())
...
;
    ...
    mod.method("jlopencv_cv_ml_Boost_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::Boost::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::ANN_MLP>("ml_ANN_MLP", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_ANN_MLP_load",  [](String& filepath) { auto retval = cv::ml::ANN_MLP::load(filepath); return retval;});mod.add_type<cv::ml::LogisticRegression>("ml_LogisticRegression", jlcxx::julia_base_type<cv::ml::StatModel>())
...
;
    ...
    mod.method("jlopencv_cv_ml_LogisticRegression_load",  [](String& filepath, String& nodeName) { auto retval = cv::ml::LogisticRegression::load(filepath, nodeName); return retval;});mod.add_type<cv::ml::SVMSGD>("ml_SVMSGD", jlcxx::julia_base_type<cv::ml::StatModel>())
